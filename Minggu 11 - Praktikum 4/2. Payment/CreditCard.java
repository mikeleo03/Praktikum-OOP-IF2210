class CreditCard implements IPaymentMethod {
    ...
    public CreditCard() {
        ...
        this.unpaidBalance = 0.00;
        this.monthlyLimit = CreditCard.defaultLimit;
        this.dailyInterest = CreditCard.defaultInterest;
    }
    ...
    public void endBillingCycle() {
        this.unpaidBalance = this.unpaidBalance + this.monthlyBalance;
    ...
    public boolean payOffBalance(double amount) {
        if (amount > this.monthlyBalance + this.unpaidBalance) {
            ...
            } else if (amount < this.monthlyBalance) {
